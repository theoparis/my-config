...
map("n", "<leader>sc", ":source ~/.config/nvim/init.lua<CR>",
    {silent = true, noremap = true, silent = true})
map("n", "<C-_>", ":call nerdcommenter#Comment('n', 'Toggle')<CR>",
    {silent = true, noremap = true})
map("v", "<C-_>", ":call nerdcommenter#Comment('v', 'Toggle')<CR>",
    {silent = true, noremap = true})
...
map("n", "<leader>g]", ":lua vim.diagnostic.goto_next()<CR>",
    {silent = true, noremap = true})
map("n", "<leader>ar", ':lua require("renamer").rename()<CR>',
    {silent = true, noremap = true})
map("n", "<leader>gh", "copilot#Accept()",
    {silent = true, noremap = true, expr = true})
map("i", "<leader>gh", "copilot#Accept()",
    {silent = true, noremap = true, expr = true})
